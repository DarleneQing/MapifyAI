...
2. requests._sse_response invokes stream_pipeline from backend/app/agents/graph.py.
3. Graph node progress events are streamed; final state contains orchestrator output from _orchestrator_node.
